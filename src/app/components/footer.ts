      ...
      <div class="container-max py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p class="text-sm text-slate-400">Master your coding skills with our comprehensive online judge platform.</p>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="#" class="text-slate-400 hover:text-white transition-colors">Problems</a></li>
              <li><a href="#" class="text-slate-400 hover:text-white transition-colors">Leaderboard</a></li>
              <li><a href="#" class="text-slate-400 hover:text-white transition-colors">Submissions</a></li>
            </ul>
          </div>
        ...
        <div class="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p class="text-sm text-slate-400">&copy; 2024 CodeJudge. All rights reserved.</p>
